            ...
            >
                ...
                >
                    ...
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        {{ $page.props.name }} makes voucher redemption easy. <br />We suggest starting with the following.
                    </p>
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span>
                                Watch video tutorials on
                                <a
                                    href="https://youtu.be/NsenElX8KaE?si=Fe8KCchMnX4d5PYw"
                                    target="_blank"
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]"
                                >
                                    <span>YouTube</span>
                ...
                <div
                    class="relative -mb-px aspect-335/376 w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002] flex items-center justify-center"
                >
                    <img src="/redeem-x.svg" :alt="`${$page.props.name} logo`" class="max-w-full max-h-full object-contain" />
                </div>
            </main>
        </div>
