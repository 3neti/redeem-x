...
// Helper functions
function createVoucherWithTimeWindow(
    User $user,
    string $startTime,
    string $endTime
): Voucher {
    ...
    return createVoucherWithTimeValidation($user, $timeValidation);
}

function createVoucherWithDurationLimit(
    User $user,
    int $limitMinutes
): Voucher {
    $timeValidation = TimeValidationData::from([
...
function createVoucherWithTimeWindowAndDuration(
    User $user,
    string $startTime,
    string $endTime,
    int $limitMinutes
...
function createVoucherWithTimeValidation(
    User $user,
    TimeValidationData $timeValidation
): Voucher {
